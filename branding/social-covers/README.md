...
Ready-to-upload cover/banner images for the PCI AI and PCI World social profiles, built from the
...
**PCI AI** (www.projectcontrolsinstitute.org · pciglobal.ai · pciworld.org · pciai.org):

| File | Upload as | Rendered at |
|---|---|---|
| `pci-ai-facebook-cover-1640x624.png` | Facebook Page cover (displays 820×312 desktop) | 2× (1640×624) |
| `pci-ai-linkedin-company-cover-2256x382.png` | LinkedIn company page cover (displays 1128×191) | 2× (2256×382) |
| `pci-ai-linkedin-personal-banner-3168x792.png` | LinkedIn personal profile banner (displays 1584×396) | 2× (3168×792) |
