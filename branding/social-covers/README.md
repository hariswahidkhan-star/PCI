...
Ready-to-upload cover/banner images for the PCI Global social profiles, built from the site's own
brand assets (`backend/wwwroot/assets`: Archivo/Inter fonts, the PCI plate logo, the navy/crimson
palette) so they match the website exactly.
