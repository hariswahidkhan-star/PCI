...
public static class PublicDocsSeed
{
    ...
    static Doc[] Core() => new[]
    {
        new Doc("certification-scheme-and-governance-framework", "PCI Certification Scheme and Governance Framework",
            ...
            (B.H1,"Purpose"),
            (B.Body,"This framework describes how the Project Controls Institute (PCI) governs its certification scheme for the PCI AI Project Leadership Certification Suite — PCI AI Project Controls Leader (PCI PCL-AI), PCI AI Project Finance Leader (PCI PFL-AI) and PCI AI Project Management Leader (PCI PML-AI). It sets out the roles, decision-making, and safeguards that keep certification decisions competence-based, impartial and consistent."),
        ...
        new Doc("general-candidate-handbook", "General Candidate Handbook",
            ...
            (B.Body,"PCI offers three certifications: PCI AI Project Controls Leader (PCI PCL-AI), PCI AI Project Finance Leader (PCI PFL-AI) and PCI AI Project Management Leader (PCI PML-AI). Each has its own body of knowledge and examination blueprint. You may pursue more than one over time."),
