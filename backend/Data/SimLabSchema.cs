...
public static class SimLabSchema
{
    ...
    static void Seed(Db db)
    {
        ...
        //    validated as publishable + gradable by SimSeedContentTests. Codes are disjoint from the
        //    SimLabContentPack seeded below (verified — no scenario_code collisions). ──
