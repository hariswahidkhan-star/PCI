...
INSERT OR IGNORE INTO pages(slug,title,meta_description,nav_group,noindex,published) VALUES('enrol.html','Enrol — Become a Student Member | PCI','Enrolment for the PCI certifications — PCL-AI, PFL-AI and PML-AI — is now open. Register your interest and start your application.','Certifications',0,1);
...
INSERT OR IGNORE INTO pages(slug,title,meta_description,nav_group,noindex,published) VALUES('events.html','Annual Events — Project Controls Institute','PCI&#x27;s flagship gatherings — the PCI ai Congress, World Summit, AI in Project Controls Conference and regional conferences for the project-controls.','Other',0,1);
