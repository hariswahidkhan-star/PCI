...
INSERT OR IGNORE INTO pages(slug,title,meta_description,nav_group,noindex,published) VALUES('route-standard.html','Standard route — Project Controls Institute','Enrol on the standard route: create a free account, activate membership, pay the exam fee and earn the PCP-AI credential.','Membership',0,1);
