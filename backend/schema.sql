...
CREATE UNIQUE INDEX IF NOT EXISTS ux_item_i18n ON item_i18n(entity, entity_id, lang, field);
CREATE INDEX IF NOT EXISTS ix_item_i18n_lookup ON item_i18n(lang, entity);
