...
public class WorldIntelligenceTests
{
    ...
    public void Coverage_report_counts_honestly_and_raises_the_runway_alert()
    {
        ...
        Assert.Equal(200, (int)G("mapped"));
        Assert.Equal(165, (int)G("planned"));
        Assert.Equal(200, (int)G("backed_by_published_challenge"));
        // January–June are fully authored: 181 consecutive backed days from day 1, with July
        // day 182 planned. The 60-day alert stays cleared — with real published content.
        Assert.Equal(181, (int)G("runway_days"));
