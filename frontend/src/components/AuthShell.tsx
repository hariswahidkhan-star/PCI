...
export default function AuthShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="auth-page">
      {/* The sign-in screen is the FIRST thing a reviewer sees, and in demonstration mode the
          credentials on it are not real either — the notice has to be here, not only past the gate. */}
      <DemoBanner />
