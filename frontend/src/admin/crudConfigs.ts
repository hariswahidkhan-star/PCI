...
export const RESOURCES: CrudConfig = {
  ...
  title: 'Resources',
  perm: 'resources',
  description: 'Documents shown on the public Downloads page (grouped by category) and available to students.',
  addLabel: 'Add resource',
  fields: [
    { key: 'title', label: 'Title', inList: true, required: true },
    { key: 'category', label: 'Category (public page group)', inList: true },
    { key: 'doc_type', label: 'Type' },
    { key: 'url', label: 'URL', inList: true },
    { key: 'description', label: 'Short description (shown under the link)' },
    { key: 'published', label: 'Published', type: 'checkbox', inList: true },
    { key: 'sort_order', label: 'Sort order', type: 'number' },
  ],
}
...
export const NEWS: CrudConfig = {
  ...
  title: 'News',
  perm: 'news',
  description: 'Announcements shown in the "Latest updates" section of the public Insights and Blog pages.',
  addLabel: 'Add news item',
  fields: [
    { key: 'title', label: 'Title', inList: true, required: true },
    { key: 'body', label: 'Body', type: 'textarea' },
    { key: 'published_date', label: 'Published date (YYYY-MM-DD)', inList: true },
    { key: 'url', label: 'Link (optional page the title points to)' },
    { key: 'published', label: 'Published', type: 'checkbox', inList: true },
    { key: 'sort_order', label: 'Sort order', type: 'number' },
  ],
}
...
export const BOK: CrudConfig = {
  ...
  perm: 'bok',
  description: 'Knowledge domains shown on the public Body of Knowledge page, with exam weightings.',
  addLabel: 'Add domain',
  fields: [
    ...
    { key: 'bullets', label: 'Competency bullets (one per line)', type: 'textarea' },
    { key: 'sort_order', label: 'Sort order', type: 'number' },
  ],
}
