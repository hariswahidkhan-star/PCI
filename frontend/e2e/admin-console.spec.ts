...
// (owner@pci.local / changeme-owner). That published bootstrap credential must be forced through a
// password-change gate; normal journeys use the separate E2E operator.
test.describe('admin console', () => {
  ...
  test('the seeded owner is forced to replace the published bootstrap password', async ({ page }) => {
