# Building the PCL-AI Body of Knowledge PDF
...
node docs/bok/_build/bok_pdf.js /tmp/bok.html docs/bok/PCL-AI-Body-of-Knowledge-v1.pdf
```
...
/ SME-reconciliation note. The compiled `PCL-AI-Body-of-Knowledge-v1.pdf` is an **SME-verifiable first
