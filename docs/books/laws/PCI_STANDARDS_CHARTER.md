...
A PCI Law must never be described as statutory law, regulation, a government rule, legally binding
legislation, an IFRS requirement, an ISO requirement or a contractual obligation. Those terms may be
used only where they refer separately and accurately to an actual external authority.

PCI's authority is confined to its own processes: examination, certification, quality and conduct.
No PCI Law may assert or imply that PCI can impose a fine, create criminal liability, or exercise any
governmental enforcement power.
...
obligation, it is drafting defect and must be moved into an identified law or process requirement.

Levels 2 and 3 share an identifier form deliberately: the distinction between them is the breadth of
the obligation, not its citation. A law that binds the whole credential anchors to the domain that
teaches it and records the wider scope in its Scope field.
...
A PCI Law never lowers an obligation. Where an external requirement is stricter, it governs; where a
PCI Law is stricter than a permissive external position, the PCI Law governs the credential holder as
a condition of certification.

## 5. Due process

No PCI Law may be published solely because it was drafted and appeared reasonable — including where
it was drafted with AI assistance. Every law passes thirteen stages, and the record of each stage is
part of the law's file.
...
| 3 — Initial draft | The law in the mandatory structure | Draft, versioned |
...
| 8 — Scenario testing | The law tested against normal, boundary, emergency, conflict, AI-assisted, multi-jurisdiction, small-project and megaproject cases | Scenario test record |
...
| 12 — Publication | Final law, basis for conclusions, implementation guidance, effective date, superseded requirements, comment history, amendment record | Published law |
...
authority to that of a public standard-setter, and a law's file must record honestly which stages
...
**An interpretation must not silently amend a law.** If the effect of a proposed interpretation is to
add, remove, widen or narrow an obligation, it is an amendment and must go through §7. Every
interpretation is published with its date, the law it interprets, the question asked, and the
reasoning.

## 7. Amendment

A substantive change to a law requires Stages 1–12 of §5, at a depth proportionate to the change.
Every amendment records: the version superseded, what changed, why, the effective date, and any
transitional arrangement. A law's amendment history is published with the law.
...
Every law states either its exception process or that no exception is permitted. Where an exception
is permitted, the law states who may approve it, what justification is required, how long it lasts,
whether compensating controls are required, and whether it must be reported.

**No law may be silently ignored because compliance is inconvenient.** An undocumented departure is a
breach, not an exception.
...
Every published law carries a version, an approval date, an effective date, and its amendment
history. The current edition supersedes all earlier ones. Where a law is withdrawn, the withdrawal
and its reason are published; the law is not deleted from the record.
