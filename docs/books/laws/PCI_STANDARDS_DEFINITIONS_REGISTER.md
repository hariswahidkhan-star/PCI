...
| File | What it said before this reconciliation |
|---|---|
| `PCI_FOUNDATIONAL_STANDARDS.md` | **No definition**, although Manual §4 names *approved* as a term that always needs one when it appears in an obligation, and the foundational standards use it in obligations. |
