...
| **Benefits realisation** | The identification, planning, measurement and sustainment of the outcomes a programme exists to deliver |
...
**7,935 golden-answer checks** stand behind this volume. Every number printed as a *result* —
...
| 14 | Construction Monitoring and Drawdown | 356 |
...
**45 figures**, all of them drawn as PCI-original artwork generated from source
...
| 3.2.2 | Three shapes, one loan: annual debt service under annuity, level-principal and bullet | drawn |
| 3.2.3 | Outstanding principal, not debt service: Kestrel's USD 42,000,000 under four shapes | drawn |
...
| 10.1.2 | Three ways to size the same project at 1.30× | drawn |
