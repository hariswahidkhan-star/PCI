# Shared Figure & Illustration Registry — PML-AI · PFL-AI
...
| Book | Fig | Title | Type | Source | Alt text | Referenced from | Status |
|---|---|---|---|---|---|---|---|
| — | — | *(populated from Phase 1 prototypes onward; each chapter submission appends its rows)* | | | | | |

Quality bar per figure: figure number · descriptive title · source line ("PCI original" unless
licensed) · alt text (registered here and emitted in the web edition; embedded in the tagged PDF) ·
at least one in-text cross-reference · contrast checked.
