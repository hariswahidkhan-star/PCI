...
attitude and consent risk, and state what each dimension predicts that the others do not; **treat the
register as what it is — a record about identified people — with an owner, an access list, attitude
recorded as an observed act with its source, deletion of departed role holders at refresh and a
deletion point at closure**; **price a
...
by the organisation, containing recorded opinions about them. That is personal data, and the domain's
own AI treatment already states the governing principle for the machine-generated case — *an
...
influence (1–5) · interest (1–5) · attitude, recorded as the **basis of the entry — the observed act
and its source** ("objected to the interface scope in the 14 March minute"), never as a
characterisation of the person · **consent risk** (none / withholds
...
and cannot assert one and a half per cent. The register that carries all this is not a
spreadsheet: it names individuals and records opinions about them, so it has an owner and an access
list, its attitude entries are observed acts with their sources rather than characterisations of
people, departed role holders' assessments are deleted at each refresh rather than archived — at
**30.6 %** annual turnover that is nineteen deletions a year — and it carries a stated deletion point
at closure. What any of that attracts under data-protection obligations is for whoever holds that
accountability in the organisation and for qualified counsel, never for this book.
