...
schema:        Article
word_count:    637
hashtags:      #ProjectControls #EarnedValue #PMO #CostEngineering #ProjectFinance #RiskManagement #Construction
ab_id:         AB-00282
---

# The five project KPIs that actually change a decision
...
You are converting 85p of work per £1 spent. To land on budget you now need £1.09. That is the whole report.

Eight slides on five KPIs that force a decision, each with its formula, its threshold and the call it triggers. The arithmetic is on slide 3.

Full breakdown in the link in bio.

#ProjectControls #EarnedValue #PMO #CostEngineering #ProjectFinance #RiskManagement #Construction
...
|---|---|---:|
| CPI | EV ÷ AC = 8.45 ÷ 9.90 | **0.854** |
| SPI | EV ÷ PV = 8.45 ÷ 9.60 | **0.880** |
| EAC | BAC ÷ CPI = 26.4 × 9.90 ÷ 8.45 | **£30.93m** |
| VAC | BAC − EAC | **−£4.53m** |
| TCPI | (BAC − EV) ÷ (BAC − AC) = 17.95 ÷ 16.50 | **1.088** |
