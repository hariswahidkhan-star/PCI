...
Readers who would rather test the boundary than the argument can hold [the domain list this four-step test is run against](https://projectcontrolsinstitute.org/body-of-knowledge) [6] beside their own last month-end, and judge for themselves whether the crossing is covered anywhere else.
