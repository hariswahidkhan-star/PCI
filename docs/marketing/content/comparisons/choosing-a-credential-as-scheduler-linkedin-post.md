...
type:          linkedin-post
title:         Two earning rules, one month, two different stories
meta:          A £1.2m package straddling period end moves CPI from 1.07 to 0.86 on a rule nobody discussed. That rule is what a scheduler starts signing in controls.
...
# Two earning rules, one month, two different stories
...
Period earned value under 50/50: £3.0m
Under 0/100: £2.4m
Actual cost, either way: £2.8m
...
three new items. No body link, because LinkedIn suppresses reach on posts that carry one, and no
link or name for any other awarding organisation.*
